...
const pdfGenerator = async (quote, user, setLoading) => {
  ...
  doc.text(485, 145, `COTIZACION No.${quote.quoteNumber}`)
  ...
  if (customer.address) doc.text(420, 145, customer.address.toString().toUpperCase())
  if (customer.nit) doc.text(270, 160, customer.nit.toString().toUpperCase())
